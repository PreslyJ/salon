		...
		<div class='control-group'>
			...
			<div class='controls'>
				<select id="menuNode">
					...
					<option value=3>Stocks In</option>
					<option value=4>Stocks Out</option>
					<option value=8>User and Access Controls</option>
					<option value=5>Customer Care</option>
					<option value=6>Report Center</option>
					<option value=7>Information Center</option>
