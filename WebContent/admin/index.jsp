  ...
  <!--<![endif]-->
    ...
    <div class="navbar navbar-default" role="navigation">
        <div class="navbar-header">
          ...
          <a ><span class="navbar-brand"><!-- <span class="fa fa-paper-plane"></span> -->Namo Budhdhaya</span></a></div>
...
<!--                 <li><a href="./">My Account</a></li>
    ...
    <ul>
	    <li><a href="#" data-target=".dashboard-menu" class="nav-header" data-toggle="collapse"><i class="fa fa-fw fa-dashboard"></i> Main menu<i class="fa fa-collapse"></i></a></li>
	    <li><ul class="dashboard-menu nav nav-list collapse in">
	            <li><a href="#" onclick="$('#basicbody').load('informationCenter.jsp');"><span class="fa fa-caret-right"></span> Information Center</a></li>
	    </ul></li>

		<li><a href="#" data-target=".legal-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-legal"></i>Reference Data<i class="fa fa-collapse"></i></a></li>
		...
		<li ><a href="sign-in.html"><span class="fa fa-caret-right"></span> Sign In</a></li>
            ...
            <li ><a href="#" onclick="$('#basicbody').load('user.html');"><span class="fa fa-caret-right"></span> User Profile</a></li>   
    ...
    <div class="content" id="basicbody">
        <div class="header">
            <div class="stats">
